...
Description: Specia Companion is created for Specia Theme. The plugin set frontpage sections, It allow edit customizer settings for the theme. Extend your theme functionalities with one click import & enjoy free stock images. Try to install Specia Companion, 25+ Theme Supported
Version: 2.4
Author: specia
...
define('SPECIA_COMPANION_VER', '2.4');
